...
{
    public class GunRepository : Repository<ShootingEntities, Gun>, IGunRepository
    {
        ...
        {
            return base.GetAll().Include("Caliber").Include("GunType").Include("Manufacturer").Include("GunImages").Include("ShootingSessions").Include("BarrelLengthUnit");
        }
