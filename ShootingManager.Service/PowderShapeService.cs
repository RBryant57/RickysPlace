...
{
    public class PowderShapeService : IPowderShapeService
    {
        private IPowderShapeRepository repository;
        ...
        {
            var newEntity = this.repository.Add((PowderShape)entity);
        ...
        {
            this.repository.Edit((PowderShape)entity);
            this.repository.Save();
        }

        public void Delete(IEntity entity)
        {
            this.repository.Delete((PowderShape)entity);
            this.repository.Save();
        }
