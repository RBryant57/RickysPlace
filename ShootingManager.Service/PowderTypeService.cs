...
namespace ShootingManager.Service
{
    ...
    {
        private IPowderTypeRepository repository;
        ...
        {
            var newEntity = this.repository.Add((PowderType)entity);
        ...
        {
            this.repository.Edit((PowderType)entity);
            this.repository.Save();
        }

        public void Delete(IEntity entity)
        {
            this.repository.Delete((PowderType)entity);
            this.repository.Save();
        }
