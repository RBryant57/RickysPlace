...
{
    public class BulletRepository : Repository<ShootingContext1, Bullet>, IBulletRepository
    {
        ...
        {
            //var list = new List<BulletView>();
            //try {
            //    foreach (var bullet in Context.BulletViews)
            //    {
            //        list.Add(bullet);
            //    }
            //}
